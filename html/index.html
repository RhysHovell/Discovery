...
<body>
    ...
    <div class="img-wrapper">
        ...
        <div class="img-overlay">
            <div class="container">
                <h1>What are you here for? <span class="label label-default"></span></h1>

                <button class="btn btn-md btn-responsive">Equipment</button>
                <button class="btn btn-md btn-responsive">Guided Tours</button>
            </div>
