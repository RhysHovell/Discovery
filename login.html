 ...
 <div class="img-wrapper">
    ...
    <div class="img-overlay">
        ...
        <form action = "login.php" method="post">
            <input style="border-radius:6px; "type ="text" name="username" placeholder="Username"><br>
            <input style="border-radius:6px; "type="password" name="password" placeholder="******"><br>
            <input style="border-radius:4px; "type ="submit">
            </form>
            </div>
